...
<template>
  <a href="/cart" class="p-2 hover:bg-white/10 rounded-full transition-colors relative group">
    ...
    <span 
      ...
      class="absolute top-1 right-1 bg-accent text-black text-[10px] font-black w-5 h-5 flex items-center justify-center rounded-full border-2 border-primary shadow-sm animate-in fade-in zoom-in duration-300"
    >
      {{ totalItems }}
    </span>
  </a>
