...
<template>
  <div class="flex flex-col gap-12">
    ...
    <div
      v-else
      class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-12 animate-in fade-in duration-700"
    >
      <div v-for="product in products" :key="product.id" class="relative group">
        ...
        <div
          class="absolute top-4 left-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity"
        >
          <button
            class="bg-white/90 backdrop-blur-sm p-2 rounded-xl shadow-sm text-gray-700 hover:text-primary transition-colors"
          >
            <svg
              class="w-4 h-4"
              fill="none"
          ...
          <button
            class="bg-white/90 backdrop-blur-sm p-2 rounded-xl shadow-sm text-gray-700 hover:text-error transition-colors"
          >
            <svg
              class="w-4 h-4"
              fill="none"
